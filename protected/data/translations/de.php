...
return array(
    ...
    'yes'              => 'Ja',
    'no'               => 'Nein',
    'Actions that can be called' => 'Aktionen, die ausgeführt werden können',
    'Recover'          => 'Zurücksetzen',
    'There is an schema available to migrate. Please click the button to do so.' => 'Es ist ein Update für das Datenbank-Schema verfügbar. Bitte drücken Sie den Button um zu updaten.',
    'Application' => 'Anwendung',
    'Database' => 'Datenbank',
    'Settings' => 'Einstellungen',
    'App Title' => 'Titel der Anwendung',
    'Username' => 'Benutzername',
    'Table Prefix' => 'Tabellen-Präfix',
    'Database Schema' => 'Datenbank-Schema',
    'Latest'          => 'Aktuell',
    'Installed'       => 'Installiert',
    'Migrate Schema'  => 'Migriere Schema',
    'Server Requirements' => 'Server-Anforderungen',
    'Writable Paths' => 'Beschreibbare Pfade',
    'Search by Keyword' => 'Nach Stichwort suchen',
    'Where are these Themes from?' => 'Wo sind die Themes her?',
    'Recover Password' => 'Passwort zurücksetzen',
    'An email with an link back to this site will be sent to your email address.' => 'Eine E-Mail mit einem Link zurück zu dieser Seite wird an Ihre E-Mail-Adresse verschickt.',
    'There were some errors.' => 'Es sind Fehler aufgetreten.',
    'Migrate Database Schema' => 'Datenbank-Schema migrieren',
    'Migrate the schema <strong>%s</strong>?' => 'Soll das Schema <strong>%s</strong> wirklich migriert werden?',
    'Cancel' => 'Abbrechen',
    'Migrate' => 'Migrieren',
    'Articles' => 'Artikel',
    'Categories' => 'Kategorien',
    '&empty; Articles' => '&empty; Artikel',
    'Users' => 'Benutzer',
    'Articles Lately' => 'Artikel in letzter Zeit',
    'Articles per Category' => 'Artikel pro Kategorie',
    'Title' => 'Titel',
    'Date' => 'Datum',
    'Content' => 'Inhalt',
    'Homepage' => 'Startseite',
    'View' => 'Betrachten',
    'No results matched' => 'Es wurden keine Einträge gefunden für',
    'Select Some Options' => 'Bitte wählen...',
    ...
    'Last' => 'Letzte',
    'First' => 'Erste',
    'When you add a new user, an email with his credentials is sent to the given email address' => 'Wenn ein neuer Benutzer angelegt wird, wird eine E-Mail mit den Zugangsdaten an die hinterlegte Adresse geschickt.',
    'Firstname' => 'Vorname',
    'Lastname' => 'Nachname',
    'Role' => 'Benutzerrolle',
    'Edit Article "%s"' => 'Artikel "%s" bearbeiten',
    'Delete Article' => 'Artikel löschen',
    'Are you sure to delete the article "%s"?' => 'Sie sind sicher, dass Sie den Artikel "%s" löschen möchten?',
    'Delete' => 'Löschen',
    'Edit' => 'Bearbeite',
    'Add Category' => 'Kategorie hinzufügen',
    'Edit Category "%s"' => 'Kategorie "%s" bearbeiten',
    'Delete Category' => 'Kategorie löschen',
    'Are you sure to delete the category "%s"?' => 'Möchten Sie die Kategorie "%s" wirklich löschen?',
    'Add User' => 'Benutzer hinzufügen',
    'Edit User "%s"' => 'Benutzer "%s" bearbeiten',
    'Delete User' => 'Benutzer löschen',
    'Are you sure to delete the user "%s"?' => 'Wollen Sie den Benutzer "%s" wirklich löschen?',
    'Roles' => 'Benutzerrollen',
    'Add Role' => 'Benutzerrolle hinzufügen',
    'Actions' => 'Aktionen',
    'Edit Role "%s"' => 'Benutzerrolle "%s" bearbeiten',
    'Delete Role' => 'Benutzerrolle löschen',
    'Are you sure to delete the role "%s"?' => 'Wollen Sie die Benutzerrolle "%s" wirklich löschen?',
    'Frequently Asked Questions' => 'Häufig gestellte Fragen',
    'Account info' => 'Account-Informationen',
    'Password Repeat' => 'Passwort wiederholen',
    'A record with the supplied identity could not be found.' => 'Ein Datensatz mit der gegebenen Identität konnte nicht gefunden werden.',
    'Supplied credential is invalid.' => 'Das eingegebene Passwort stimmt nicht.'
);